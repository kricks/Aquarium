            ...
            <body ng-app="myApp" class="container ng-cloak">
                ...
                <form:form method="POST" action="aquarium-details" modelAttribute="aquarium">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Gallons</label>
                            <form:input path="gallon" type="number" min="0" class="form-control" id="inputGallons" placeholder="Enter Gallons"></form:input>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Notes</label>
                            <form:input path="notes" type="text" class="form-control" id="inputDesc" placeholder="Enter Description"></form:input>
                        </div>
                    </div>
                    <div>
                ...
                <div ng-controller="aquariumListController as ctrl">
                    <form ng-submit="ctrl.submit()" name="aquariumForm">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" ng-model="ctrl.aquarium.name" name="tName" class="form-control" 
                                placeholder="Enter Name" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="type">Type</label>
                                <select name="tType" class="form-control" id="type" ng-model="ctrl.aquarium.type">
                                    <option>Fresh Water</option>
                                    <option>Salt Water</option>
                                    <option>Brackish Water</option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0" ng-model="ctrl.aquarium.gallon" name="tGal" 
                                class="form-control" id="gallon" placeholder="Enter Gallons">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="notes">Notes</label>
                                <input type="text" ng-model="ctrl.aquarium.notes" name="tNotes" 
                                class="form-control" id="notes" placeholder="Enter Notes">
                            </div>
                        </div>
                        <div>
                            <div class="float-right">
                    ...
                    <script src="<c:url value='/static/js/services/aquariumListService.js' />"></script>
                    <script src="<c:url value='/static/js/controller/aquariumListController.js' />"></script>
            </body>
